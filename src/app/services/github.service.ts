...
export type RepositoryDetailsQueryVariables = Exact<{
  name: Scalars['String'];
  owner: Scalars['String'];
}>;
...
export type RepositoryDetailsQuery = (
  ...
  & { repository?: Maybe<(
    { __typename?: 'Repository' }
    & Pick<Repository, 'name' | 'description' | 'createdAt' | 'homepageUrl' | 'url' | 'forkCount'>
...
export type RepositoriesByAuthorQueryVariables = Exact<{
  login: Scalars['String'];
  count: Scalars['Int'];
}>;


export type RepositoriesByAuthorQuery = (
  { __typename?: 'Query' }
  & { repositoryOwner?: Maybe<(
    ...
    & { repositories: (
      ...
      & { edges?: Maybe<Array<Maybe<(
        ...
        & { node?: Maybe<(
          { __typename?: 'Repository' }
          & Pick<Repository, 'name' | 'createdAt'>
          & { primaryLanguage?: Maybe<(
            { __typename?: 'Language' }
            & Pick<Language, 'name'>
          )>, owner: (
...
export const RepositoryDetailsDocument = gql`
  ...
  export class RepositoryDetailsGQL extends Apollo.Query<RepositoryDetailsQuery, RepositoryDetailsQueryVariables> {
    document = RepositoryDetailsDocument;
    
    constructor(apollo: Apollo.Apollo) {
      super(apollo);
    }
  }
export const RepositoriesByAuthorDocument = gql`
  ...
  export class RepositoriesByAuthorGQL extends Apollo.Query<RepositoriesByAuthorQuery, RepositoriesByAuthorQueryVariables> {
    document = RepositoriesByAuthorDocument;
